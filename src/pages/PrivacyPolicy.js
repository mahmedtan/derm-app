...
const PrivacyPolicy = () => {
  return (
    <Main overflow="hidden" pad="large" align="center">
      <Box width="large">
        ...
        <Heading level="3">Interpretation and Definitions</Heading>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to CHIC DERM &amp; AESTHETICS, 5717
              Legacy Drive, Suite 250 Plano, Texas 75024.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Chic Derm &amp; Aesthetics ,
              accessible from{" "}
              <a
                href="http://www.mydermpa.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                http://www.mydermpa.com
              </a>
            </p>
          </li>
          <li>
        ...
        <Heading level="3">Collecting and Using Your Personal Data </Heading>
        <Heading level="4">Types of Data Collected</Heading>
        <Heading level="5">Personal Data</Heading>
        <p>
        ...
        <Heading level="5">Usage Data</Heading>
        ...
        <Heading level="4">Use of Your Personal Data</Heading>
        ...
        <Heading level="4">Retention of Your Personal Data</Heading>
        <p>
        ...
        <Heading level="4">Transfer of Your Personal Data</Heading>
        <p>
        ...
        <Heading level="4">Disclosure of Your Personal Data</Heading>
        <Heading level="5">Business Transactions</Heading>
        <p>
        ...
        <Heading level="5">Law enforcement</Heading>
        <p>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <Heading level="5">Other legal requirements</Heading>
        <p>
        ...
        <Heading level="4">Security of Your Personal Data</Heading>
        <p>
        ...
        <Heading level="3">Links to Other Websites</Heading>
        <p>
        ...
        <Heading level="3">Changes to this Privacy Policy</Heading>
        <p>
        ...
        <ul>
          <li>
            <p>By email: contact@mydermpa.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="https://mydermpa.com/contact-us"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://mydermpa.com/contact-us
              </a>
            </p>
          </li>
        </ul>
